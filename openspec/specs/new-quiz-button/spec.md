...
Defines the requirements for the New Quiz button feature — a UI control on the quiz page that loads a fresh set of trivia questions using the same category, type, and amount parameters as the current quiz session.
