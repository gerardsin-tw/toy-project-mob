...
Defines the requirements for the dark mode toggle feature — a client-side UI control that switches the app between light and dark visual themes and persists the preference via `localStorage`.
