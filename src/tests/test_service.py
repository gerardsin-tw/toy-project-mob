...
async def test_fetch_trivia(httpx_mock):
    ...
    httpx_mock.add_response(url="https://opentdb.com/api.php?amount=1&type=multiple&category=9", json=mock_response)
...
async def test_fetch_trivia_number_of_questions(httpx_mock):
    ...
    httpx_mock.add_response(url="https://opentdb.com/api.php?amount=2&type=multiple&category=9", json=mock_response)
...
async def test_fetch_trivia_type_boolean(httpx_mock):
    ...
    httpx_mock.add_response(url="https://opentdb.com/api.php?amount=1&type=boolean&category=9", json=mock_response)
...
async def test_fetch_trivia_category(httpx_mock):
    ...
    httpx_mock.add_response(url="https://opentdb.com/api.php?amount=1&type=multiple&category=11", json=mock_response)
